...
<div class="container" style="background: rgba(255, 255, 255, 0.9); padding: 30px; max-width: 500px; box-shadow: 0 0 15px rgba(0, 0, 0, 0.3); border-radius: 10px; color: #333;">
    <div class="row justify-content-center">
        <div class="col-md-12 text-center">
            ...
            <h2 class="text-center" style="font-size: 28px; margin-bottom: 20px; color: navy; text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.1);"><b>{{ __('Reset Password') }}</b></h2>
            <hr>
            ...
            <form method="POST" action="{{ route('forgot.password') }}" class="user">
                ...
                <div class="form-group">
                    <input type="password" class="form-control form-control-user" name="password" placeholder="{{ __('New Password') }}" required style="border-radius: 25px; border-color: navy;">
                </div>
