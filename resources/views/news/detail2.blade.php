...
<div class="container mt-4">
    ...
    <div class="text-center mb-4">
        <img src="{{ asset('sb-admin-2/img/login/slide2.png') }}" class="img-fluid rounded w-100" style="max-height: 400px; object-fit: cover;" alt="Banner Merchandise">
    </div>

    <!-- Judul Artikel -->
    <p class="text-left text-muted mb-5">Kamis, 07 November 2024</p>
    <h2 class="text-left text-uppercase font-weight-bold mb-3" style="font-size: 2rem; color: #333;">Kanitra Merch Collection</h2>
